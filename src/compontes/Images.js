...
class Images extends Component {
  ...
  renderOne() {
    ...
    return  <Grid>
      <Row>
        <Col xs={12} md={12} lg={12} className={`  background`} onClick={this.openModal.bind(this, 0)} style={{background: `url(${images[0]})`}}>
          {overlay}
        </Col>
      </Row>
    </Grid>;
  ...
  renderTwo() {
    ...
    return <Grid>
      <Row>
        <Col xs={6} md={6} lg={6} className="border-rad height-two background" onClick={this.openModal.bind(this, conditionalRender ? 1 : 0)} style={{background: `url(${conditionalRender ? images[1] : images[0]})`}}>
          {this.renderOverlay()}
        </Col>
        <Col xs={6} md={6} lg={6} className="border-rad-tow height-two background" onClick={this.openModal.bind(this, conditionalRender ? 2 : 1)} style={{background: `url(${conditionalRender ? images[2] : images[1]})`}}>
          {overlay}
        </Col>
      </Row>
    </Grid>;
  ...
  renderThree(more) {
    ...
    return <Grid>
      <Row>
        <Col xs={6} md={4} lg={4} className=" height-three background" onClick={this.openModal.bind(this, conditionalRender ? 1 : 2)} style={{background: `url(${conditionalRender ? images[1] : images[2]})`}}>
          {this.renderOverlay(conditionalRender ? 1 : 2)}
        </Col>
        <Col xs={6} md={4} lg={4} className=" height-three background" onClick={this.openModal.bind(this, conditionalRender ? 2 : 3)} style={{background: `url(${conditionalRender ? images[2] : images[3]})`}}>
          {this.renderOverlay(conditionalRender ? 2 : 3)}
        </Col>
        <Col xs={6} md={4} lg={4} className="height-three background" onClick={this.openModal.bind(this, conditionalRender ? 3 : 4)} style={{background: `url(${conditionalRender ? images[3] : images[4]})`}}>
          {overlay}
        </Col>
      </Row>
    </Grid>;
